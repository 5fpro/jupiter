...
ActiveRecord::Schema.define(version: 20160330140816) do
  ...
  add_index "records", ["todo_id"], name: "index_records_on_todo_id", using: :btree
  ...
  add_index "users", ["todos_published"], name: "index_users_on_todos_published", using: :btree
