...
namespace :load do
  task :defaults do
    set :slack_team,         -> { '5fpro' }
    set :slack_webhook,      -> { 'https://hooks.slack.com/services/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' }
    set :slack_icon_url,     -> { 'https://slack-assets2.s3-us-west-2.amazonaws.com/5504/img/emoji/1f680.png' }
    set :slack_channel,      -> { '#jupiter-notify' }
    set :slack_username,     -> { 'Jupiter' }
